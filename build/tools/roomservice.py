...
custom_dependencies = "horizon.dependencies"
org_manifest = "HorizonDroid-Devices"  # leave empty if org is provided in manifest
org_display = "HorizonDroid-Devices"  # needed for displaying
